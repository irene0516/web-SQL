    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="whereteacher" id="whereteacher2" value="teacher5" readonly>
...
<!-- 註冊的model****************************************************************
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> Username</label>
              <input type="text" class="form-control" name="whereteacher" id="whereteacher" value="teacher5" readonly>
...
<!-- 修改的model****************************************************************
      ***************************************************************************end-->
              ...
              <table class="table table-striped table-advance table-hover"  >
                <h3><i class="fa fa-angle-right"></i>行動商務與多媒體應用學系</h3>
                <hr>
                <thead>
                  <tr>
